...
// If the application is in a subdirectory of the web root, specify it here.
// For example, if your app is accessible at http://localhost/myapp/,
// then BASE_PATH should be '/myapp/'.
// If your app is at the web root, BASE_PATH should be '/'.
...
// define('DEBUG_MODE', true); // For development
?>
