...
<form action="/index.php?url=accreditation/update/<?php echo $data['process']['id']; ?>" method="POST">
    <div>
...
<?php endif; ?>
<p><a href="/index.php?url=accreditation/show/<?php echo $data['process']['id']; ?>">Back to Process Details</a></p>
