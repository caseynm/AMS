...
<?php if (isset($data['process'])): ?>
    ...
    <?php if (isset($_SESSION['user_id']) && isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'superuser'): ?>
        <p><a href="/index.php?url=document/showCreateForm/<?php echo $data['process']['id']; ?>">Add New Document</a></p>
    <?php endif; ?>
        ...
        <ul>
            <?php foreach ($data['documents'] as $doc): ?>
                <li id="doc<?php echo $doc['id'];?>">
                    ...
                    | <a href="/index.php?url=task/listByDocument/<?php echo $doc['id']; ?>">View/Manage Tasks</a>
                    <?php if (isset($_SESSION['user_id']) && isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'superuser'): ?>
                        | <a href="/index.php?url=document/showEditForm/<?php echo $doc['id']; ?>">Edit Doc</a>
                        | <a href="/index.php?url=document/delete/<?php echo $doc['id']; ?>/<?php echo $data['process']['id']; ?>" onclick="return confirm('Are you sure you want to delete this document and all its tasks?');">Delete Doc</a>
                    <?php endif; ?>
                     | <a href="/index.php?url=comment/showByEntity/document/<?php echo $doc['id']; ?>">Comments</a>
                </li>
            <?php endforeach; ?>
        </ul>
    <?php else: ?>
    ...
    <p><a href="/index.php?url=comment/showByEntity/process/<?php echo $data['process']['id']; ?>">View/Add Comments for Process</a></p>

    <p><a href="/index.php?url=accreditation/index">Back to All Processes</a></p>
<?php else: ?>
