...
<?php if (isset($_SESSION['user_id']) && isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'superuser'): ?>
    <p><a href="<?php echo htmlspecialchars($APP_BASE_URL); ?>accreditation/showCreateForm">Create New Accreditation Process</a></p>
<?php endif; ?>
...
<?php if (isset($data['processes']) && !empty($data['processes'])): ?>
    <ul>
        <?php foreach ($data['processes'] as $process): ?>
            <li>
                <a href="<?php echo htmlspecialchars($APP_BASE_URL); ?>accreditation/show/<?php echo $process['id']; ?>">
                ...
                <?php if (isset($_SESSION['user_id']) && isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'superuser'): ?>
                    ...
                    | <a href="<?php echo htmlspecialchars($APP_BASE_URL); ?>accreditation/delete/<?php echo $process['id']; ?>" onclick="return confirm('Are you sure you want to delete this process and all related data?');">Delete</a>
                <?php endif; ?>
            </li>
        <?php endforeach; ?>
    </ul>
