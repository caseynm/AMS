...
<?php if (isset($data['document_id']) && isset($data['document_name'])): ?>
    ...
    <form action="/index.php?url=task/create/<?php echo $data['document_id']; ?>" method="POST">
        <div>
    ...
    <p><a href="/index.php?url=task/listByDocument/<?php echo $data['document_id']; ?>">Back to Tasks for Document</a></p>
<?php else: ?>
