...
<?php if (isset($data['entity_type_display']) && isset($data['entity_name_display']) && isset($data['entity_type']) && isset($data['entity_id']) && isset($data['back_link'])): ?>
    ...
    <br>
    <p><a href="<?php echo htmlspecialchars($APP_BASE_URL); ?><?php echo htmlspecialchars($data['back_link']); // Controller provides path like 'controller/action/param' ?>">Back to <?php echo htmlspecialchars($data['entity_type_display']); ?></a></p>
<?php else: ?>
    <p>Error: Entity information for comments is missing.</p>
    <p><a href="<?php echo htmlspecialchars($APP_BASE_URL); ?>home/index">Return to Dashboard</a></p>
<?php endif; ?>
