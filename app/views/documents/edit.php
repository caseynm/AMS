...
<form action="/index.php?url=document/update/<?php echo $data['document']['id']; ?>" method="POST">
    <div>
...
<p><a href="/index.php?url=accreditation/show/<?php echo $data['document']['accreditation_process_id']; ?>#doc<?php echo $data['document']['id']; ?>">Back to Process Details</a></p>
<?php else: ?>
